...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 style="font-size:1.5rem;color:#0d6efd;" class="mb-0 fw-bold">Edit Subscription</h3>
            ...
            <form action="{{ route('admin.subscriptions.update', $subscription->id) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" name="name" value="{{ old('name', $subscription->name) }}" placeholder="Enter name">
                    ...
                    <div class="col-md-4 mb-3">
                        <label>Title</label>
                        <input type="text" class="form-control" name="title" value="{{ old('title', $subscription->title) }}" placeholder="Enter title">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control" name="monthly_price" value="{{ old('monthly_price', $subscription->monthly_price) }}" placeholder="Enter monthly price">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control" name="yearly_price" value="{{ old('yearly_price', $subscription->yearly_price) }}" placeholder="Enter yearly price">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="form-select" name="is_popular">
                            <option value="0" {{ old('is_popular', $subscription->is_popular) == '0' ? 'selected' : '' }}>No</option>
                            <option value="1" {{ old('is_popular', $subscription->is_popular) == '1' ? 'selected' : '' }}>Yes</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <div id="features_wrapper" class="d-flex flex-column gap-2">
                            @php
                                $features = old('features', json_decode($subscription->features, true) ?? []);
                            @endphp
