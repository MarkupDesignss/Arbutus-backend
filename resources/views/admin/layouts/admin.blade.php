...
<head>
    ...
    <title>Arbutus Partner Admin</title>
    ...
    <header class="main-header">
        <div class="header-left">
            ...
            <div class="logo-container">
                <div class="brand-text">Arbutus Partner</div>
            </div>
        </div>
        ...
        <div class="user-info">
            ...
            <div class="user-avatar-container">
                 @php
                        ...
                        @endphp
                <div class="user-avatar" id="profileToggle">
                    <img src="{{ $logoPath }}" alt="Admin Avatar" class="avatar-img">
                </div>
                
                <!-- Profile Dropdown Menu -->
                <div class="profile-dropdown" id="profileDropdown">
                    <div class="dropdown-header">
                        <img src="https://ui-avatars.com/api/?name={{ Auth::guard('admin')->user()->name }}&background=random&size=60" alt="Admin Avatar" class="dropdown-avatar">
                    ...
                    <div class="dropdown-details">
                        <div class="detail-item">
                            ...
                            <span class="detail-value">{{ Auth::guard('admin')->user()->name }}</span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">Email:</span>
                            <span class="detail-value">{{ Auth::guard('admin')->user()->email }}</span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">Mobile:</span>
                            <span class="detail-value">{{ Auth::guard('admin')->user()->mobile ?? 'N/A' }}</span>
                        </div>
                    </div>
